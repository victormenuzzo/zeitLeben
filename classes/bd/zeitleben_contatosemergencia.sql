...
--
-- Table structure for table `contatosemergencia`
--

DROP TABLE IF EXISTS `contatosemergencia`;
...
--
-- Dumping data for table `contatosemergencia`
--

LOCK TABLES `contatosemergencia` WRITE;
/*!40000 ALTER TABLE `contatosemergencia` DISABLE KEYS */;
/*!40000 ALTER TABLE `contatosemergencia` ENABLE KEYS */;
UNLOCK TABLES;
