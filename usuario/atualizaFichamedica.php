...
<div class = "formTotal" style="background-image: url('fundo.jpg'); background-size:110%;  padding:20px;">
    <div class ="joga" style="margin-left:34%;">
        <form action="#" method="post">
            <fieldset>
                <h1 style="color:black; font-weight:800">Atualizar Ficha Médica</h1>
               
 
                    <div class="campo">
                        <label for="remediosContr"><h4 style = "color:#494848;">Remédios Controlados</h4></label>
                        <input type="text" id="remediosContr" name="remediosContr" style="width: 20em;opacity:0.7; border-radius: 13px;" value="">
                    </div>
                    <div class="campo">
                        <label for="alergias"><h4 style = "color:#494848;">Alergias<h4></label>
                        <input type="text" id="alergias" name="alergias" style="width: 13em;opacity:0.7; border-radius: 13px;" value="">
                    </div>

                    <div class="campo">
                        <label for="plano"><h4 style = "color:#494848;">Plano de Saúde<h4></label>
                        <input type="text" id="plano" name="plano" style="width: 13em;opacity:0.7; border-radius: 13px;" value="">
                    </div>
...
<?php
    ...
    $remediosContr = array($_POST['remediosContr']);

    if (isset($botao)){
        
        $alterar = new AlteraBanco($_SESSION['user']);

        $alterar->alteraFichaMedica($alergias, $remediosContr, $_POST['plano']);
    }
?>