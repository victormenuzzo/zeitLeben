...
<div class = "formTotal" style="background-image: url('fundo.jpg'); background-size:110%; padding:20px;">
    <div class ="joga" style="margin-left:34%;">
        <form action="#" method="post">
            <fieldset>
                <h1 style="color:black; font-weight:800">Atualizar Contato</h1>
               
 
                    <div class="campo">
                        <label for="email"><h4 style = "color:#494848;">Email</h4></label>
                        <input type="text" id="email" name="email" style="width: 20em; opacity:0.7; border-radius: 13px;" value="">
                    </div>
                    <div class="campo">
                        <label for="telefone"><h4 style = "color:#494848;">Telefone<h4></label>
                        <input type="text" id="telefone" name="telefone" style="width: 13em; opacity:0.7; border-radius: 13px;" value="">
                    </div>
   <!--
            <div class="campo">
                    <label for="cpf"><h4 style = "color:white;">Confirmar CPF</h4></label>
...
<?php
    ...
    if (isset($botao)){
        ...
        $alterar->alteraContato($_POST['telefone'], $_POST['email'], $_SESSION['user']);
